...
/*
   ...
   weakness Revised Febrary 2 2015: randint() can now be seeded (see
   exercise 5.13). Revised June 15 for defaultfloat hack for older GCCs
*/
...
inline ios_base &
defaultfloat(ios_base &b) // to augment fixed and scientific as in C++11
{
